...
class User(UserMixin, db.Model):
    ...
    sent_dms     = db.relationship("Message",
                       foreign_keys="Message.sender_id",
                       backref="sender", lazy=True)
    received_dms = db.relationship("Message",
                       foreign_keys="Message.receiver_id",
                       backref="receiver", lazy=True)

    # forum-thread posts
    thread_posts = db.relationship("ThreadMessage",
                       foreign_keys="ThreadMessage.author_id",
...
class Forum(db.Model):
    ...
    # relationships
    messages = db.relationship("ThreadMessage", backref="thread", cascade="all, delete-orphan", lazy=True)
