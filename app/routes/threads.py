...
from app import db
from app.models.models import StudyGroup, Forum, ThreadMessage, Membership, Message
...
def new_thread(group_id):
    ...
    return render_template('new_thread.html', form=form, group=group, unread_count=unread_count)
